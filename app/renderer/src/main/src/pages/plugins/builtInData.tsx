...
export const pluginTypeToName: Record<string, PluginTypeInfoProps> = {
    yak: {
        name: i18next.t("Yak 原生插件"),
        description: i18next.t("内置了众多网络安全常用库，可快速编写安全小工具，该原生模块只支持手动调用"),
    ...
    mitm: {
        name: i18next.t("Yak-MITM 模块"),
        description: i18next.t("专用于 MITM 模块中的模块，编写 MITM 插件，可以轻松对经过的流量进行修改"),
    ...
    "port-scan": {
        name: i18next.t("Yak-端口扫描"),
        description: i18next.t("该插件会对目标进行端口扫描，再对扫描的指纹结果做进一步的处理，常用场景先指纹识别，再 Poc 检测"),
    ...
    codec: {
        name: "Yak-Codec",
        description: i18next.t("Yakit 中的编解码模块，可以自定义实现所需要的编解码、加解密"),
    ...
    lua: {
        name: i18next.t("Lua 模块"),
        description: i18next.t("监修中，无法使用"),
    ...
    nuclei: {
        name: i18next.t("Nuclei YamI 模块"),
        description: i18next.t("使用 YakVM 构建了一个沙箱，可以兼容执行 Nuclei DSL ，无感使用 Nuclei 自带的 Yaml 模板"),
...
export const aduitStatusToName: Record<string, {name: string; icon: ReactNode}> = {
    "0": {name: i18next.t("待审核"), icon: <SolidFlagIcon className='aduit-status-flag-color' />},
    "1": {name: i18next.t("已通过"), icon: <SolidBadgecheckIcon className='aduit-status-badge-check-color' />},
    "2": {name: i18next.t("未通过"), icon: <SolidBanIcon className='aduit-status-ban-color' />}
}
/** @name 审核状态选择列表 */
...
export const publicStatusToInfo: Record<string, {name: string; icon: ReactNode}> = {
    "1": {name: i18next.t("公开"), icon: <SolidCloudpluginIcon />},
    "2": {name: i18next.t("私密"), icon: <SolidPrivatepluginIcon />}
}
/** @name 公开状态选择列表 */
