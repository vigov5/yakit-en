...
const pluginGroupArr:string[] = [i18next.t("基础扫描"),i18next.t("操作系统类漏洞"),i18next.t("WEB中间件漏洞"),i18next.t("WEB应用漏洞"),i18next.t("网络安全设备漏洞"),i18next.t("OA产品漏洞"),i18next.t("CMS产品漏洞"), i18next.t("弱口令"), i18next.t("CVE合规漏洞")]
